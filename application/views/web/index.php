        ...
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top">
                    ...
                    <span style="margin-left:45px;">&nbsp;PPDB <?= $user['nama_lengkap']; ?></span>
                </a>
            </div>
                        ...
                        <?php if ($web_ppdb->status_ppdb == 'buka') { ?>
                            <span>
                                ...
                                <a href="logcs" class="btn btn-danger" style="margin: 5px; border-radius: 6px;">
                                    ...
                                    <a href="https://docs.google.com/forms/d/e/1FAIpQLSdNy6kaxpykZuiNiWXkqaLnoUEkf2vmf_48Vd0v2zHYlYZtAw/viewform" class="btn btn-primary" style="margin: 5px; border-radius: 6px;">
                                        <i class="fa fa-list faa-pulse"></i> &nbsp;
                                        <b>KIRIM FILE</b>
                                    </a>
                                <br>
